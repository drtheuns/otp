...
start_channel(Role, SupPid, ConnRef, Callback, Id, Args, Exec, Opts, HandlerContext) ->
    ChannelSup = channel_supervisor(SupPid),
    ssh_channel_sup:start_child(Role, ChannelSup, ConnRef, Callback, Id, Args, Exec, Opts, HandlerContext).
